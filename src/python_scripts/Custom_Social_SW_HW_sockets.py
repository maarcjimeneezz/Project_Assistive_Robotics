...
movel_shake = f"movel(p[{X}, {Y}, {Z}, {Roll}, {Pitch}, {Yaw}], a={accel_mss}, v={speed_ms}, t={timel/2}, r={blend_r})"
...
movel_give5 = f"movel(p[{X}, {Y}, {Z}, {Roll}, {Pitch}, {Yaw}], a={accel_mss}, v={speed_ms}, t={timel/2}, r={blend_r})"
...
def Init():
    ...
    if robot_is_connected:
        ...
        time.sleep(1)                               # modify the time if needed
